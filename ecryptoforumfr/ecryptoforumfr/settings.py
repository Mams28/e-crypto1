"""
Django settings for ecryptoforumfr project.
...
SECRET_KEY = '@9z1=zx7u4(sgby4aus*aa$1dc5!j_b8=mh*ij&*-v+it9_*9f'
...
ROOT_URLCONF = 'ecryptoforumfr.urls'
...
WSGI_APPLICATION = 'ecryptoforumfr.wsgi.application'
